...
window.onload = async () => {
    ...
    // solo gráfico de inicio en la página cargada por primera vez
...
// establecer el modo oscuro para los gráficos
setDarkChart = (dark) => {
    let theme = {
        theme: {
